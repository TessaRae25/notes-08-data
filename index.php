     ...
     <header> 
            ...
            <section class="note-hold">
                ...
                <section class="ink-holder">
                        <!-- Form element below, is called 'notesForm'. It's job is to determine using the action, onsubmit and method attributes, what will hapen when someone clicks on the submit button. In this case, our form will reach out and reference the upload.php file when the submit button is clicked. -->
